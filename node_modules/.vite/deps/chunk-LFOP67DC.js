...
function initializeUserActionsAPI({ transports, internalLogger: internalLogger2, config }) {
  var _a;
...
var ConsoleInstrumentation = class _ConsoleInstrumentation extends BaseInstrumentation {
  ...
  initialize() {
    ...
    allLogLevels.filter((level) => {
      var _a2;
      return !((_a2 = instrumentationOptions === null || instrumentationOptions === void 0 ? void 0 : instrumentationOptions.disabledLevels) !== null && _a2 !== void 0 ? _a2 : _ConsoleInstrumentation.defaultDisabledLevels).includes(level);
    }).forEach((level) => {
      console[level] = (...args) => {
        try {
...
//# sourceMappingURL=chunk-LFOP67DC.js.map
