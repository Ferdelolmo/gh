...
function deepEqual(a2, b2) {
  ...
  if (isTypeof(a2, "number") && isNaN(a2)) {
    return isTypeof(b2, "number") && isNaN(b2);
  }
  ...
  if (aIsArray && bIsArray) {
    ...
    for (let idx = length; idx-- !== 0; ) {
      if (!deepEqual(a2[idx], b2[idx])) {
        return false;
      }
    }
    return true;
  }
  const aIsObject = isObject(a2);
  const bIsObject = isObject(b2);
  if (aIsObject !== bIsObject) {
    return false;
  }
  if (a2 && b2 && aIsObject && bIsObject) {
...
function stringifyObjectValues(obj = {}) {
  ...
  for (const [key, value] of Object.entries(obj)) {
    o2[key] = isObject(value) && value !== null ? stringifyExternalJson(value) : String(value);
  }
  return o2;
}
...
var Observable = class _Observable {
  ...
  first() {
    ...
    const subscription2 = this.subscribe(internalSubscriber);
...
var UserAction = class extends Observable {
  ...
  cancel() {
    ...
    this._state = UserActionState.Ended;
    this.notify(this._state);
    this._pushEvent(userActionEventName, Object.assign({ userActionName: this.name, userActionStartTime: this.startTime.toString(), userActionEndTime: endTime.toString(), userActionDuration: duration.toString(), userActionTrigger: this.trigger, userActionImportance: this.importance }, stringifyObjectValues(this.attributes)), void 0, {
...
function initializeUserActionsAPI({ transports, internalLogger: internalLogger2, config, pushEvent }) {
  ...
  const startUserAction = (name, attributes, options) => {
    ...
    if (currentRunningUserAction === void 0) {
      ...
      userAction.filter((v2) => [UserActionState.Ended, UserActionState.Cancelled].includes(v2)).first().subscribe(() => {
...
function monitorConsole(unpatchedConsole2) {
  ...
  if (!isInstrumented) {
    const originalConsole = unpatchedConsole2 !== null && unpatchedConsole2 !== void 0 ? unpatchedConsole2 : defaultUnpatchedConsole;
...
var ConsoleInstrumentation = class _ConsoleInstrumentation extends BaseInstrumentation {
  ...
  initialize() {
    ...
    const disabledLevels = (_b = instrumentationOptions === null || instrumentationOptions === void 0 ? void 0 : instrumentationOptions.disabledLevels) !== null && _b !== void 0 ? _b : _ConsoleInstrumentation.defaultDisabledLevels;
...
var x = (t2, e2 = {}) => {
  ...
  const v2 = (t3, e3) => {
    ...
    const e3 = t3.entries[0], i2 = d2.get(e3), r3 = e3.processingStart, s2 = Math.max(e3.startTime + e3.duration, r3), a3 = Math.min(i2.processingEnd, s2), c3 = i2.entries.sort(((t4, e4) => t4.processingStart - e4.processingStart)), f2 = v2(e3.startTime, a3), u2 = o2.h.get(e3.interactionId), h2 = { interactionTarget: l2.get(u2), interactionType: e3.name.startsWith("key") ? "keyboard" : "pointer", interactionTime: e3.startTime, nextPaintTime: s2, processedEventEntries: c3, longAnimationFrameEntries: f2, inputDelay: r3 - e3.startTime, processingDuration: a3 - r3, presentationDelay: s2 - a3, loadState: n(e3.startTime), longestScript: void 0, totalScriptDuration: void 0, totalStyleAndLayoutDuration: void 0, totalPaintDuration: void 0, totalUnattributedDuration: void 0 };
    ((t4) => {
      ...
      d3 >= e4 + n2 + o3 && (c4 = t4.nextPaintTime - d3), i3 && r4 && (t4.longestScript = { entry: i3, subpart: r4, intersectingDuration: f3 }), t4.totalScriptDuration = s3, t4.totalStyleAndLayoutDuration = a4, t4.totalPaintDuration = c4, t4.totalUnattributedDuration = t4.nextPaintTime - e4 - s3 - a4 - c4;
    })(h2);
    ...
    const o3 = ((t3) => {
      ...
      if (t3.entries.length) {
        ...
        if (o4) {
          ...
          n4 = { target: r2.get(i2), timeToFirstByte: a2, resourceLoadDelay: c2 - a2, resourceLoadDuration: f2 - c2, elementRenderDelay: t3.value - f2, navigationEntry: o4, lcpEntry: i2 }, i2.url && (n4.url = i2.url), s2 && (n4.lcpResourceEntry = s2);
        }
      }
...
function convertDataAttributeName(userActionDataAttribute2) {
  ...
  const withUpperCase = withoutData === null || withoutData === void 0 ? void 0 : withoutData.replace(/-(.)/g, (_2, char) => char.toUpperCase());
  ...
  if (!isInstrumented3) {
    ...
    if (hasNavigation) {
      onNavigateHandler = (e2) => {
        try {
          const destination = e2 === null || e2 === void 0 ? void 0 : e2.destination;
...
var NavigationInstrumentation = class extends BaseInstrumentation {
  ...
  initialize() {
    ...
    const activityWindowTracker = new ActivityWindowTracker(new Observable().merge(httpMonitor, domMutationsMonitor, urlMonitor), {
      ...
      isOperationStart: (msg) => isRequestStartMessage2(msg) ? msg.request.requestId : void 0,
      isOperationEnd: (msg) => isRequestEndMessage2(msg) ? msg.request.requestId : void 0
    });
    activityWindowTracker.filter((msg) => {
      return msg.message === "tracking-ended";
    }).subscribe((msg) => {
      var _a, _b, _c;
      if (((_a = msg.events) === null || _a === void 0 ? void 0 : _a.some((e2) => e2.type === "url-change")) && ((_b = msg.events) === null || _b === void 0 ? void 0 : _b.some((e2) => e2.type === "dom-mutation"))) {
        const urlChange = (_c = msg.events) === null || _c === void 0 ? void 0 : _c.find((e2) => e2.type === "url-change");
...
//# sourceMappingURL=chunk-VF4Z5KSW.js.map
