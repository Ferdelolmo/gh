...
function withFaroErrorBoundary(WrappedComponent, errorBoundaryProps) {
  ...
  const Component3 = (wrappedComponentProps) => import_react3.default.createElement(
    FaroErrorBoundary,
    Object.assign({}, errorBoundaryProps),
    import_react3.default.createElement(WrappedComponent, Object.assign({}, wrappedComponentProps))
  );
...
(function(ReactRouterVersion2) {
  ...
  ReactRouterVersion2["V7"] = "v7";
  ReactRouterVersion2["V7_data_router"] = "v7_data_router";
...
function FaroRoute(props) {
  ...
  return import_react4.default.createElement(Route, Object.assign({}, props));
}
...
// node_modules/@grafana/faro-react/dist/esm/router/v6v7/FaroRoutes.js
var import_react5 = __toESM(require_react());

// node_modules/@grafana/faro-react/dist/esm/router/v6v7/routerDependencies.js
...
// node_modules/@grafana/faro-react/dist/esm/router/v6v7/utils.js
...
function FaroRoutes(props) {
  ...
  const routes = (0, import_react5.useMemo)(() => {
    var _a2;
  ...
  const lastRouteRef = (0, import_react5.useRef)({});
  ...
  return import_react5.default.createElement(ActualRoutes, Object.assign({}, props));
}

// node_modules/@grafana/faro-react/dist/esm/router/v6v7/initialize.js
...
// node_modules/@grafana/faro-react/dist/esm/router/v6v7/withFaroRouterInstrumentation.js
...
var FaroProfiler = class extends import_react6.Component {
...
function withFaroProfiler(WrappedComponent, options) {
  ...
  const Component3 = (props) => import_react7.default.createElement(
    FaroProfiler,
    { name: componentDisplayName, updateProps: props },
    import_react7.default.createElement(WrappedComponent, Object.assign({}, props))
  );
