...
function parsePairKeyValue2(entry) {
  if (!entry)
    return;
  const metadataSeparatorIndex = entry.indexOf(BAGGAGE_PROPERTIES_SEPARATOR2);
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/common/globalThis.js
var _globalThis3;
...
function getTimeOrigin2() {
  return otperformance2.timeOrigin;
}
...
// node_modules/@opentelemetry/otlp-transformer/node_modules/@opentelemetry/core/build/esm/common/timer-util.js
...
var require_utils = __commonJS({
  "node_modules/@opentelemetry/otlp-transformer/build/src/common/utils.js"(exports) {
    ...
    function hrTimeToNanos(hrTime6) {
      ...
      return BigInt(Math.trunc(hrTime6[0])) * NANOSECONDS + BigInt(Math.trunc(hrTime6[1]));
    }
...
var require_internal2 = __commonJS({
  "node_modules/@opentelemetry/otlp-transformer/build/src/trace/internal.js"(exports) {
    ...
    function createExportTraceServiceRequest2(spans, encoder) {
      return {
  ...
  for (const resourceSpan of resourceSpans) {
    ...
    for (const scopeSpan of scopeSpans) {
      ...
      for (const span of spans) {
        ...
        api.pushEvent(`faro.tracing.${eventName}`, faroEventAttributes, void 0, {
          spanContext,
          ...
          customPayloadTransformer: (payload) => {
            ...
            if (faroEventAttributes["faro.action.user.name"] != null && faroEventAttributes["faro.action.user.parentId"] != null) {
              ...
              (_a2 = payload.attributes) === null || _a2 === void 0 ? true : delete _a2["faro.action.user.name"];
...
var FaroTraceExporter = class {
  ...
  export(spans, resultCallback) {
    const traceEvent = (0, import_internal.createExportTraceServiceRequest)(spans, import_utils10.JSON_ENCODER);
...
function hrTime3(performanceNow) {
  const timeOrigin = millisToHrTime3(otperformance3.timeOrigin);
...
function timeInputToHrTime3(time) {
  if (isTimeInputHrTime3(time)) {
    ...
    if (time < otperformance3.timeOrigin) {
      return hrTime3(time);
    } else {
...
function hrTime5(performanceNow) {
  const timeOrigin = millisToHrTime5(otperformance5.timeOrigin);
...
function timeInputToHrTime5(time) {
  if (isTimeInputHrTime5(time)) {
    ...
    if (time < otperformance5.timeOrigin) {
      return hrTime5(time);
    } else {
  ...
  detect(_config) {
    ...
    if (rawAttributes) {
      try {
        ...
        diag2.debug(`EnvDetector failed: ${e instanceof Error ? e.message : e}`);
      }
    }
    if (serviceName2) {
      attributes[ATTR_SERVICE_NAME] = serviceName2;
...
function buildSamplerFromEnv2() {
  const sampler = getStringFromEnv("OTEL_TRACES_SAMPLER") ?? TracesSamplerValues2.ParentBasedAlwaysOn;
  switch (sampler) {
    ...
    default:
      diag2.error(`OTEL_TRACES_SAMPLER value "${sampler}" invalid, defaulting to "${TracesSamplerValues2.ParentBasedAlwaysOn}".`);
      return new ParentBasedSampler2({
        root: new AlwaysOnSampler2()
      });
  }
...
var TRACE_BUFFER2 = new Uint8Array(TRACE_ID_BYTES2);
var SPAN_BUFFER2 = new Uint8Array(SPAN_ID_BYTES2);
var HEX2 = Array.from({ length: 256 }, (_, i) => i.toString(16).padStart(2, "0"));
...
var RandomIdGenerator2 = class {
   ...
   */
  generateTraceId() {
    randomFill(TRACE_BUFFER2);
    return toHex(TRACE_BUFFER2);
  }
  /**
   ...
   */
  generateSpanId() {
    randomFill(SPAN_BUFFER2);
    return toHex(SPAN_BUFFER2);
  }
};

// node_modules/@opentelemetry/sdk-trace-web/node_modules/@opentelemetry/sdk-trace-base/build/esm/semconv.js
...
// node_modules/@opentelemetry/sdk-trace-web/node_modules/@opentelemetry/sdk-trace-base/build/esm/TracerMetrics.js
var TracerMetrics = class {
  ...
  startSpan(parentSpanCtx, samplingDecision) {
    ...
    if (samplingDecision === SamplingDecision3.NOT_RECORD) {
      return () => {
      };
    }
...
function samplingDecisionToString(decision) {
  switch (decision) {
    case SamplingDecision3.RECORD_AND_SAMPLED:
      return "RECORD_AND_SAMPLE";
    case SamplingDecision3.RECORD:
      return "RECORD_ONLY";
    case SamplingDecision3.NOT_RECORD:
      return "DROP";
  }
}

// node_modules/@opentelemetry/sdk-trace-web/node_modules/@opentelemetry/sdk-trace-base/build/esm/version.js
var VERSION12 = "2.6.0";
...
var Tracer2 = class {
  ...
  constructor(instrumentationScope, config, resource, spanProcessor) {
    ...
    const meter = localConfig.meterProvider ? localConfig.meterProvider.getMeter("@opentelemetry/sdk-trace", VERSION12) : createNoopMeter();
...
var BasicTracerProvider2 = class {
  ...
  getTracer(name, version, options) {
    ...
    if (!this._tracers.has(key)) {
      this._tracers.set(key, new Tracer2({ name, version, schemaUrl: options?.schemaUrl }, this._config, this._resource, this._activeSpanProcessor));
    }
...
var TracingInstrumentation = class _TracingInstrumentation extends BaseInstrumentation {
  ...
  initialize() {
    ...
    attributes[ATTR_PROCESS_RUNTIME_NAME6] = "browser";
    ...
    const provider = new WebTracerProvider3({
      ...
      spanProcessors: [
        (_b = options.spanProcessor) !== null && _b !== void 0 ? _b : new FaroMetaAttributesSpanProcessor(new BatchSpanProcessor2(new FaroTraceExporter({ api: this.api }), {
...
var FaroUserActionSpanProcessor = class {
  ...
  onStart(span, parentContext) {
    ...
    if (userAction && (userAction === null || userAction === void 0 ? void 0 : userAction.getState()) === UserActionState.Started && span.kind === SpanKind.CLIENT) {
