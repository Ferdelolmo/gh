var GrafanaFaroReact=function(e,t,r){"use strict";const n={hasError:!1,error:null};let o,i;const a=t.version,u=p(),c=d(19),s=d(18),l=d(17),f=d(16);function p(){const e=a.split(".");try{return e[0]?parseInt(e[0],10):null}catch(e){return null}}function d(e){return null!==u&&u>=e}class m extends t.Component{constructor(e){super(e),this.state=n,this.resetErrorBoundary=this.resetErrorBoundary.bind(this)}getErrorWithComponentStack(e,t){if(!l||!t.componentStack)return e;const r=new Error(e.message);return r.name=`React ErrorBoundary ${e.name}`,r.stack=t.componentStack,r}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,t){var r,n,o,a;const u=this.getErrorWithComponentStack(e,t);null===(n=(r=this.props).beforeCapture)||void 0===n||n.call(r,u),i.pushError(u,this.props.pushErrorOptions),null===(a=(o=this.props).onError)||void 0===a||a.call(o,u),this.setState({hasError:!0,error:e})}componentDidMount(){var e,t;null===(t=(e=this.props).onMount)||void 0===t||t.call(e)}componentWillUnmount(){var e,t;null===(t=(e=this.props).onUnmount)||void 0===t||t.call(e,this.state.error)}resetErrorBoundary(){var e,t;null===(t=(e=this.props).onReset)||void 0===t||t.call(e,this.state.error),this.setState(n)}render(){if(!this.state.hasError)return r.isFunction(this.props.children)?this.props.children():this.props.children;const e=r.isFunction(this.props.fallback)?this.props.fallback(this.state.error,this.resetErrorBoundary):this.props.fallback;return t.isValidElement(e)?e:(this.props.fallback&&(null==o||o.warn("ErrorBoundary\n",'Cannot get a valid ReactElement from "fallback"')),null)}}function b(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var y,g={exports:{}},v={};var h,O,P,S,j={};
