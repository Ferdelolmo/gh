...
var const_1 = require("./monitors/const");
 ...
 */
var ActivityWindowTracker = /** @class */ (function (_super) {
    __extends(ActivityWindowTracker, _super);
    function ActivityWindowTracker(eventsObservable, options) {
        var _a, _b, _c, _d;
        var _this = _super.call(this) || this;
        _this._tracking = false;
        _this.eventsObservable = eventsObservable;
        _this._options = {
            ...
            isOperationStart: (_c = options === null || options === void 0 ? void 0 : options.isOperationStart) !== null && _c !== void 0 ? _c : (function () { return undefined; }),
            isOperationEnd: (_d = options === null || options === void 0 ? void 0 : options.isOperationEnd) !== null && _d !== void 0 ? _d : (function () { return undefined; }),
        };
        _this._initialize();
        return _this;
    }
    ActivityWindowTracker.prototype._initialize = function () {
        var _this = this;
        this.eventsObservable
            .filter(function () {
            return _this._tracking;
        })
            .subscribe(function (event) {
            var _a, _b, _c;
            _this._lastEventTime = Date.now();
            (_a = _this._currentEvents) === null || _a === void 0 ? void 0 : _a.push(event);
            var startKey = _this._options.isOperationStart(event);
            if (startKey) {
                (_b = _this._activeOperations) === null || _b === void 0 ? void 0 : _b.set(startKey, true);
            }
            var endKey = _this._options.isOperationEnd(event);
            if (endKey) {
                (_c = _this._activeOperations) === null || _c === void 0 ? void 0 : _c.delete(endKey);
            }
            _this._scheduleInactivityCheck();
        });
    };
    ActivityWindowTracker.prototype.startTracking = function () {
        if (this._tracking) {
            return;
        }
        this._tracking = true;
    ...
    ActivityWindowTracker.prototype.stopTracking = function () {
    ...
    ActivityWindowTracker.prototype._scheduleInactivityCheck = function () {
        var _this = this;
        this._inactivityTid = startTimeout(this._inactivityTid, function () {
            if (_this.hasActiveOperations()) {
    ...
    ActivityWindowTracker.prototype._startDrainTimeout = function () {
        var _this = this;
        this._drainTid = startTimeout(this._drainTid, function () {
            _this.stopTracking();
        }, this._options.drainTimeoutMs);
    };
    ActivityWindowTracker.prototype.hasActiveOperations = function () {
        return !!this._activeOperations && this._activeOperations.size > 0;
    };
    ActivityWindowTracker.prototype._clearTimer = function (id) {
        if (id) {
            clearTimeout(id);
        }
    };
